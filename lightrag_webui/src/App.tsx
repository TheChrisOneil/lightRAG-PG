...
import ReplyTesting from './features/ReplyTesting_tnc' // TNC Tech Nexus Clarity add reply
          ...
          <main className="flex h-screen w-screen overflow-hidden">
            ...
            >
              ...
              <div className="relative grow">
                ...
                {/* ------------------------TNC Tech Nexus Clarity add reply */}
                <TabsContent value="reply" className="absolute top-0 right-0 bottom-0 left-0 overflow-hidden">
                  <ReplyTesting />
                </TabsContent>  
                {/* ------------------------TNC Tech Nexus Clarity add reply */}
