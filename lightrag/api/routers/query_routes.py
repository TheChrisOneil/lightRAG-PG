 ...
 * └─────────────────────────────────────────────┘
 ...
 Description: Injects Rag instance into the FastAPI app.
 """
...
from ..utils_api_tnc import get_rag_from_app
...
def create_query_routes(rag, api_key: Optional[str] = None, top_k: int = 60):
    ...
    async def query_text(request: QueryRequest, rag: Any = Depends(get_rag)):
        """
    ...
    async def query_text_stream(request: QueryRequest, rag: Any = Depends(get_rag)):
        """
