...
class LightRAG:
    ...
    workspace: str = field(default="default")  # TNC
    """Workspace for namespacing stored data across different environments."""
    #-------------------------------------------------------
    ...
    def __post_init__(self):
        ...
        logger.info(f"LightRAG init with param:\n  {_print_config}\n")
    ...
    async def apipeline_process_enqueue_documents(
        ...
        logger.info("LightRAG/lightrag: Getting pipeline status")
    ...
    async def _process_entity_relation_graph(
        ...
        try:
            # logger.debug("Processing chunk dict" + str(chunk))
