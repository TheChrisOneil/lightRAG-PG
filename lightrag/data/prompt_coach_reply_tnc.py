...
- **Conversation History**
{history}"""
PROMPT_COACH["test1"] = """testing 1st prompt"""
PROMPT_COACH["counselor_prompt"] = """This is an example of a multi-line prompt.
It spans multiple lines."""
PROMPT_COACH["school_counselor_topic_focused_reply"] = """---Role---

You are a supportive and engaging life coach assisting a student in conversation. Your goal is to capture the students goals and metrics as it relates to a high school student.  Keep the conversation engaging for ONLY as long as it takes to capture a metric.
